...
class Message:
    ...
    def send_secret_message(self):
        ...
        if len(self._message) > 100:
            ...
            Friends.no +=1
            self.output_file = "D:\pycharm\harit\MySpy\EncreptedImage\Output" + str(Friends.no) + ".jpg"

            #encrypting the message
            Steganography.encode("D:\pycharm\harit\MySpy\image\puppie.jpg", self.output_file, self._message)
